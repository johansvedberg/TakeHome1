...
public class GlobalSimulation{
	...
	public static final int START = 1, COMPONENT1BREAK = 2, COMPONENT2BREAK = 3, COMPONENT3BREAK = 4, COMPONENT4BREAK = 5, COMPONENT5BREAK = 6, SYSTEMFAILURE = 7; // The events, add or remove if needed!
